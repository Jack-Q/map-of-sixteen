<?php
    ...
    function db_querySQL($SQLQuery, &$result) {
        ...
        if (db_connectDatabase($databaseConnection) === -1) {
            return -1;
        }
    ...
    if (strpos($lower_UA, 'windows nt 6.1') !== FALSE) {
        ...
        $system = 'Windows 8.1';
    } elseif (strpos($lower_UA, 'windows nt 6.4') !== FALSE) {
        $system = 'Windows 10 Technical Preview';
    } elseif (strpos($lower_UA, 'windows nt 10.0') !== FALSE) {
        $system = 'Windows 10';
        ...
        $system = 'Windows Phone(unknown version)';
    } elseif (strpos($lower_UA, 'windows nt') !== FALSE) {
        $system = 'Windows (unknown version)';
    } elseif (strpos($lower_UA, 'android 5.0') !== FALSE) {
        $system = 'Android 5.0';
    } elseif (strpos($lower_UA, 'android 5') !== FALSE) {
        $system = 'Android 5.x';
        ...
        $system = 'Android';
    } elseif (strpos($lower_UA, 'cpu iphone os 8') !== FALSE) {
        $system = 'iOS 8 (iPhone)';
        ...
        $system = 'iOS x (iPhone)';
    } elseif (strpos($lower_UA, 'cpu os 8') !== FALSE) {
        $system = 'iOS 8 (iPad)';
